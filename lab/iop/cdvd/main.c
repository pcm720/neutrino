...
#define IOP_RUN_SPEED    0  // read throughput: sceCdRead / fioRead / sceCdStRead
#define IOP_RUN_STREAM   1  // parameterized sceCdSt* sweep
...
static const int __attribute__((unused)) k_bufmax[]  = {32};
static const int __attribute__((unused)) k_bankmax[] = {4};
